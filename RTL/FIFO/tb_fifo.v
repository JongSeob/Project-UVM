...
// You can add your stimulus here
    ...
    always begin
        ...
        // write to fifo
        for(test_vec=0; test_vec < 17; test_vec = test_vec + 1) begin
            #20
            wr_en   = 1'b1;
            data_in = test_vec;
            #20
        ...
        // write to fifo            
        for(test_vec=0; test_vec < 15; test_vec = test_vec + 1) begin
            #20
            wr_en   = 1'b1;
            data_in = test_vec;
            #20
        ...
        // read from fifo                    
        for(test_vec=0; test_vec < 11; test_vec = test_vec + 1) begin
            #20
            rd_en = 1'b1;
            #20
            rd_en = 1'b0;        
        ...
        // read from fifo            
        for(test_vec=0; test_vec < 7; test_vec = test_vec + 1) begin
            #20
            rd_en = 1'b1;
            #20
            rd_en = 1'b0;        
        ...
        // write to fifo
        for(test_vec=0; test_vec < 13; test_vec = test_vec + 1) begin
            #20
            wr_en   = 1'b1;
            data_in = test_vec;
            #20
